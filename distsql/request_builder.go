...
// SetTableRangesForMultiTbl sets "KeyRanges" for "kv.Request" by converting multiples "tableRanges"
// to "KeyRanges" firstly.
func (builder *RequestBuilder) SetTableRangesForMultiTbl(tids []int64, tableRanges []*ranger.Range, fb *statistics.QueryFeedback) *RequestBuilder {
	if builder.err == nil {
...
// SetIndexRangesForMultiTbl sets "KeyRanges" for "kv.Request" by converting multiple indexes range
// "ranges" to "KeyRanges" firstly.
func (builder *RequestBuilder) SetIndexRangesForMultiTbl(sc *stmtctx.StatementContext, tids []int64, idxID int64, ranges []*ranger.Range) *RequestBuilder {
	if builder.err == nil {
		builder.Request.KeyRanges, builder.err = IndexRangesToKVRangesForMultiTbl(sc, tids, idxID, ranges, nil)
	}
	return builder
}
...
// SetCommonHandleRangesForMultiTbl sets "KeyRanges" for "kv.Request" by converting common handle range
// "ranges" to "KeyRanges" firstly for multiple tables.
func (builder *RequestBuilder) SetCommonHandleRangesForMultiTbl(sc *stmtctx.StatementContext, tid []int64, ranges []*ranger.Range) *RequestBuilder {
	if builder.err == nil {
...
func IndexRangesToKVRanges(sc *stmtctx.StatementContext, tid, idxID int64, ranges []*ranger.Range, fb *statistics.QueryFeedback) ([]kv.KeyRange, error) {
	return IndexRangesToKVRangesForMultiTbl(sc, []int64{tid}, idxID, ranges, fb)
}

// IndexRangesToKVRangesForMultiTbl converts indexes ranges to "KeyRange".
func IndexRangesToKVRangesForMultiTbl(sc *stmtctx.StatementContext, tids []int64, idxID int64, ranges []*ranger.Range, fb *statistics.QueryFeedback) ([]kv.KeyRange, error) {
	if fb == nil || fb.Hist == nil {
