...
func (e *HashJoinExec) fetchInnerRows(ctx context.Context) (err error) {
	e.innerResult = chunk.NewList(e.innerExec.retTypes(), e.initChunkSize, e.maxChunkSize)
...
func (e *NestedLoopApplyExec) Open(ctx context.Context) error {
	...
	e.innerList = chunk.NewList(e.innerExec.retTypes(), e.initChunkSize, e.maxChunkSize)
