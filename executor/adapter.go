...
func (a *ExecStmt) LogSlowQuery(txnTS uint64, succ bool, hasMoreResults bool) {
	...
	if costTime < threshold {
		...
		if execDetail.CopExecDetails != nil {
			metrics.TotalCopProcHistogram.Observe(execDetail.CopExecDetails.ProcessTime.Seconds())
			metrics.TotalCopWaitHistogram.Observe(execDetail.CopExecDetails.WaitTime.Seconds())
		}
